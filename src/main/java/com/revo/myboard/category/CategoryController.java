...
public class CategoryController {
  ...
  public ResponseEntity<CreateDTO> createCategory(
  ...
  public void deleteCategoryByName(@PathVariable long id, HttpServletRequest request) {
    ...
    log.info(
        "User with ip: " + request.getRemoteAddr() + " success deleted category with id: " + id);
  }

  @PatchMapping("/rename/{id}")
  @ForAdmin
  public void renameCategoryByName(
      @PathVariable long id, @RequestBody @Valid NameDTO renameDTO,
      HttpServletRequest request) {
    log.info("User with ip: " + request.getRemoteAddr() + " renaming category with id: " + id
        + " with details: "
        + renameDTO.toString());
    categoryService.renameCategoryById(id, renameDTO.getNewName());
    log.info("User with ip: " + request.getRemoteAddr() + " success renamed category with id: " + id
        + " with details: "
        + renameDTO.toString());
  }
