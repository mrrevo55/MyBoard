...
public class CommentService {
	...
	public void editCommentById(long id, String content) {
	...
	public void editCommentByIdAsUser(String token, long id, String content) {
		if(!userService.currentLoggedUser(token).getComments().contains(getCommentById(id))){
			throw new NullPointerException("C:"+id);
		}
		editCommentById(id, content);
	}
	...
	public void deleteCommentByIdAsUser(String token, long id) {
