  ...
  public void sendActiavtionLink(String email, String code) {
    try {
      ...
      mimeBodyPart.setContent(
          "Aby aktywować swoje konto przejdź do linku: http://forum.revo-dev.pl/#/active/" + code,
      ...
      throw new EmailSendingException(
          email, exception.getMessage() + exception.getCause().getMessage());
    }

    // za duzo napchane w jednej metodzie-trzeba porozdzielac
  }
