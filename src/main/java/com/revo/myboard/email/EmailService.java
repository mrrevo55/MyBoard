...
public class EmailService {
	...
	public void sendActiavtionLink(String email, String code) throws AddressException, MessagingException {
		...
		message.setFrom(new InternetAddress("forum.revo-dev.pl"));
		message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(email));
		message.setSubject("forum.revo-dev.pl");
		var mimeBodyPart = new MimeBodyPart();
		mimeBodyPart.setContent("Aby aktywować swoje konto przejdź do linku: http://froum.revo-dev.pl:4200/#/active/" + code,
