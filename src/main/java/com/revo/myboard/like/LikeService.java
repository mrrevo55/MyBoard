...
public class LikeService {
	...
	public void giveForUserByLogin(String token, String login) {
	...
	public void removeFromUserByLogin(String token, String login) {
		var loggedUser = userService.currentLoggedUser(token);
		for (var like : userService.getUserByLogin(login).getMyLikes()) {
			if (like.getWho().equals(loggedUser)) {
